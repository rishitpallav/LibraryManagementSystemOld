<%@ page language="java" contentType="text/html; charset=ISO-8859-1" pageEncoding="ISO-8859-1" %>
    ...
    <body>
        ...
        <section
            ...
            <form style="display: block; padding: 2%;" action="/addContributor" method="POST">
                <div class="form-group">
                    <label for="contributorId">CONTRIBUTOR ID</label>
                    <input type="number" class="form-control" name="contributorId" id="contributorId" placeholder="1">
                </div>
                <div class="form-group">
                ...
                <button type="submit" id="submit" class="btn btn-primary">ADD CONTRIBUTOR</button>
            </form>
        </section>
