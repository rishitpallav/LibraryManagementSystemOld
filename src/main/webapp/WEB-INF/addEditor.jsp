<%@ page language="java" contentType="text/html; charset=ISO-8859-1" pageEncoding="ISO-8859-1" %>
    ...
    <body>
        ...
        <section
            ...
            <form style="display: block; padding: 2%;" action="/addEditor" method="POST">
                <div class="form-group">
                    <label for="editorId">EDITOR ID</label>
                    <input type="number" class="form-control" name="editorId" id="editorId" placeholder="1">
                </div>
                <div class="form-group">
                ...
                <button type="submit" id="submit" class="btn btn-primary">ADD EDITOR</button>
            </form>
        </section>
